...
I recently read [this debate]( https://github.com/johnousterhout/aposd-vs-clean-code) between John Osterhout and Uncle Bob.  This debate was about various topics of software design.  
...
If Uncle Bob Martin can't figure out this relatively trivial piece of code without a great deal of mental effor, I don't feel too ashamed to state that I probably can't either. 
...
And if you don't understand the problem, or you don't understand a given solution, you're going to make things worse if you just push some quickly generated code out to prod.
